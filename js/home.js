(function ($) {
	...
	isg_panels.find('.isg-skillbar1').each(function () {
        jQuery(this).find('.isg-skillbar-bar1').width(jQuery(this).data('percent'));
    });
	...
	isg_panels.find(".isg-panel-up1").on('click', function () {
        isg_panels.find('.isg-panel').animate({
            scrollTop: 0
        }, 500);
        return false;
    });
	isg_panels.find(".isg-panel-up2").on('click', function () {
        isg_panels.find('.isg-panel').animate({
            scrollTop: 0
        }, 500);
        return false;
    });
	isg_panels.find(".isg-panel-up3").on('click', function () {
        isg_panels.find('.isg-panel').animate({
            scrollTop: 0
        }, 500);
        return false;
    });
	isg_panels.find(".isg-panel-up4").on('click', function () {
        isg_panels.find('.isg-panel').animate({
            scrollTop: 0
        }, 500);
        return false;
    });
	isg_panels.find(".isg-panel-up5").on('click', function () {
        isg_panels.find('.isg-panel').animate({
            scrollTop: 0
        }, 500);
        return false;
    ...
    jQuery(document).ready(function () {
		...
		isg_panels.find(".isg-panel-close2").on('click', function () {
            jQuery.panelslider.close();
            return false;
        });
